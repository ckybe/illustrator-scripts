...
Languages: [English](SpectrumGradientSorter.md), [Русский](SpectrumGradientSorter.ru.md)

## Description

SpectrumGradientSorter script sorts the colors in the selected gradient according to the color spectrum.
